...
# illustration(4, 60, 400, 1, 3000000, 400, 0.005);
...
@showprogress 1 "Plotting images..." for k = 1:length(ts)
    ...
    savefig("dynamics_output_$(k).png",bbox_inches="tight", dpi=300)
    close(fig)
end
